...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 15.0.711.0-HF](https://img.shields.io/badge/AppVersion-15.0.711.0--HF-informational?style=flat-square)
...
| image.tag | string | `"15.0.711.0-HF"` | Override tag specified by `appVersion` in the chart file |
