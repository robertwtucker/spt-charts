...
![Version: 0.2.1](https://img.shields.io/badge/Version-0.2.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 15.3](https://img.shields.io/badge/AppVersion-15.3-informational?style=flat-square)
...
| image.tag | string | `"15.3.411.0-FMAP"` | Override tag specified by `appVersion` in the chart file |
